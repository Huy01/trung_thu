...
const wishList = [
  {
    text: "Trung Thu này, anh chúc bé luôn thật khỏe mạnh, thật bình an và mỗi ngày đều có một lý do để mỉm cười. 🌕❤️",
    img: "./assets/images/1.jpg",
  },
  {
    text: "Mong những ngày bận rộn của bé sẽ sớm nhẹ nhàng hơn, công việc vừa đủ, thời gian nghỉ ngơi cũng vừa đủ để bé không phải mệt quá nha.",
    img: "./assets/images/2.jpg",
  },
  {
    text: "Chúc bé có một mùa Trung Thu thật ấm áp, bên gia đình và những người bé thương. Mong mọi điều bình yên sẽ luôn ở bên bé.",
    img: "./assets/images/3.jpg",
  },
  {
    text: "Mong những điều bé đang cố gắng hôm nay rồi sẽ đổi lại bằng thật nhiều điều tốt đẹp trong những ngày sau này. Bé cứ từ từ, mọi chuyện rồi sẽ ổn thôi. 🌷",
    img: "./assets/images/1.jpg",
  },
  {
    text: "Trung Thu rồi, anh chỉ mong bé nhớ dành cho mình một chút thời gian để nghỉ ngơi, để thở, và để mỉm cười nữa nha. Sức khỏe của bé vẫn là quan trọng nhất. ❤️",
    img: "./assets/images/2.jpg",
  },
  {
    text: "Nếu ánh trăng có thể mang lời chúc đến nơi xa, thì anh gửi theo ánh trăng một lời chúc nhỏ: mong bé luôn được dịu dàng với chính mình và được cuộc sống đối xử thật dịu dàng. 🌕",
    img: "./assets/images/3.jpg",
  },
  {
    text: "Và anh cũng có một lời chúc riêng cho bé... Mong những ngày tháng sau này, giữa những bộn bề của cuộc sống, chúng mình vẫn còn có thời gian để cùng nhau mỉm cười. ❤️",
